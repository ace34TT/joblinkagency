...
<head>
    ...
    <title>Job Link Agency - Accueil</title>
...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center">
        <div class="container d-flex justify-content-center justify-content-md-between">
            <div class="contact-info d-flex align-items-center">
                <i class="bi bi-envelope-fill"></i><a href="mailto:contact@example.com">info@joblinkagency.com</a>
            </div>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">Job Link Agency</a></h1>
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>A propos</h2>
                    <p>Job Link Agency est une Société qui joue le rôle de facilitateur entre Demandeurs d’emplois et Entreprise à la recherche d’employés. Notre mission est d’exécuter toutes les procédures nécessaires pour que l’offre coïncide avec la demande. Nous aidons également les personnes qui ont déjà ciblé un poste mais sont confrontées à des difficultés administratives et logistiques pour l’atteinte en bonne et due forme de la destination finale. Nous fournissons ainsi conseils aux deux parties : recruteur et recru. </p>
                </div>
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <p>A la recherche d’emplois selon vos atouts ? (Capacité physique, diplômes, expériences…).
                        Job Link Agency s’organise pour les délais et sécurité de vos démarches. Confiez-nous l’emploi de vos rêves : ensemble, nous le réaliserons en toute légalité.
                    </p>
                </div>
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Lot FAIII90 Amborohy Ampanefy 102</p>
                            </div>
                            ...
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1333.908926421573!2d47.497966373877716!3d-18.981604381621292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x21f079e796e56a2d%3A0xad73974d4dd2c4b0!2sJob%20link%20agency%20Madagascar!5e0!3m2!1sfr!2smg!4v1622445222769!5m2!1sfr!2smg" width="100%" height="290" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>

                    </div>

                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                        <form action="index.php?action=send_message" method="post" role="form" class="php-email-form">
                            <div class="row">
