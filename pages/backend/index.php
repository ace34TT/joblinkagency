    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="index.php?action=admin_login_post" method="POST">
                    ...
                    <div class="wrap-input100 validate-input m-b-26 mt-2" data-validate="Username is required">
                        <span class="label-input100">Recruiter</span>
                        <select name="recruiter" class="col-md-12">
                            <?php
